...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String URL_KEY = "theURL";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            mUrlDisplayTextView.setText(savedInstanceState.getCharSequence(URL_KEY));
            mSearchResultsTextView.setText(savedInstanceState.getCharSequence(JSON_KEY));
        }
    }
