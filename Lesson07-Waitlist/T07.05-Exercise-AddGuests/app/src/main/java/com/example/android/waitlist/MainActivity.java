...
public class MainActivity extends AppCompatActivity {
    ...
    public void addToWaitlist(View view) {
        ...
        try {
            party_size = Integer.parseInt(mNewPartySizeEditText.getText().toString());
        } catch (Exception ex) {
        ...
        this.addGuest(mNewGuestNameEditText.getText().toString(), party_size);
    ...
    void addGuest(String name, int size) {
        ...
        mDb.insert(WaitlistContract.WaitlistEntry.TABLE_NAME, "", values);
    }
